...
(function() {{
  ...
  chart.setOption({{
    ...
    grid: {{ left:130, right:70, top:20, bottom:40 }},
    ...
    visualMap: {{ min:0, max:70, calculable:true, orient:'vertical', right:10, top:20, bottom:40,
...
(function() {{
  ...
  chart.setOption({{
    ...
    legend: {{ data: ['% Petro 2022', '% Cepeda 2026', 'Delta (pp)'], top:0, left:'center', itemWidth:10, itemHeight:10, textStyle:{{ fontSize:11 }} }},
